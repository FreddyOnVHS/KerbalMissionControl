...
namespace KMC.MissionControl.Training
{
    ...
    internal static class InstructorPropulsionFeedFailureBridge
    {
        ...
        public static bool InjectExactEngineThrustIndicationFailLow(
            MissionControlReceiver receiver,
            double delaySeconds,
            out string failureId,
            out string resultText)
        {
            ...
            string targetId =
                PropulsionEngineFailureTargets
                    .CreateExactEngineThrustIndicationTarget(
                        partId);
            ...
            SyntheticFailureRequest request =
                new SyntheticFailureRequest
                {
                    ...
                    Detail =
                        "BUILD 14.12.7 INSTRUCTOR / " +
                        "EXACT ENGINE THRUST INDICATION FAIL LOW / PART " +
                        partId.ToString()
                };
        ...
        public static bool InjectExactEngineThrustDecay(
            MissionControlReceiver receiver,
            double delaySeconds,
            out string failureId,
            out string resultText)
        {
            return
                InjectExactEngineThrustFailure(
                    receiver,
                    delaySeconds,
                    ...
                    4.0,
                    0.50,
                    "EXACT ENGINE THRUST DECAY",
                    out failureId,
                    out resultText);
        }

        public static bool InjectExactEngineUnstableThrust(
            MissionControlReceiver receiver,
            double delaySeconds,
            out string failureId,
            out string resultText)
        {
            return
                InjectExactEngineThrustFailure(
                    ...
                    4.0,
                    0.50,
                    "EXACT ENGINE UNSTABLE THRUST",
                    out failureId,
                    out resultText);
        }

        private static bool InjectExactEngineThrustFailure(
            MissionControlReceiver receiver,
            double delaySeconds,
