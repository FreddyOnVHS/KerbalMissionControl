...
{
    /// <summary>
    /// Engine-owned migration of the legacy human-in-the-loop, low-authority
    /// prograde periapsis-recovery controller.
    ///
    /// Throttle recommendations are deliberately gentle and stable enough for
    /// a remote pilot to read and follow. Cutoff bypasses command delay.
    /// </summary>
    internal sealed class PeriapsisRecoveryController
    {
        ...
        public PeriapsisRecoveryModel Calculate(
            OrbitTelemetryState current,
            CircularizationPredictionModel prediction,
            bool active)
        {
            PeriapsisRecoveryModel result =
